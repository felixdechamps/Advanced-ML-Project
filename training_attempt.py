...
stride=2
n_block = 16 # Proposition de ChatGPT : 16 (pour 32 convolutions si deux convolutions par bloc); Proposition de l'article : 48
downsample_gap = 6
...
model=ResNet1D(in_channels=1,
               base_filters=32, # Proposition de ChatGPT : 32/ Article 128 ou 64
